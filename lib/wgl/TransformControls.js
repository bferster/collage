...
// KLUDGE ////////////////////////////////////////////////
	...
	if (axis == 'X') 		app.sc.transRot[0]=rotationAngle*180/Math.PI;
	else if (axis == 'Y') 	app.sc.transRot[1]=rotationAngle*180/Math.PI;
	else if (axis == 'Z') 	app.sc.transRot[2]=rotationAngle*180/Math.PI;
